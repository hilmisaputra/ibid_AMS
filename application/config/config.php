...
$config['adms_auth']['destroy'] = "http://alpha.ibid.astra.co.id/backend/service/akun/auth/oauth2/destroy";
$config['adms_auth']['forgot'] = "http://alpha.ibid.astra.co.id/auth/forgot"; 

// Auth
// $config['ibid_auth'] = is_https() ? "https://" : "http://";
// $config['ibid_auth'] .= "ibid-ams".$base_domain;
$config['ibid_auth'] = $config['base_url'];
...
$config['sess_save_path'] 			= 'sessionams'; 
